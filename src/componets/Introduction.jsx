    ...
    return (
        ...
        min-h-screen w-full   bg-[#1A2517]  " >
            ...
            <div className="  flex flex-col items-start 
             text-amber-50 bold justify-center h-[100%]  w-auto">
                ...
                p-2 mt-[30px] hover:scale-110 transition text-center shadow-lg
                 hover:shadow-2xl rounded text-[#ACC8A2] hover:text-[#243120] hover:bg-[#74bd5e] "> 
                 Project <FontAwesomeIcon icon={faArrowDown} />  </a>
                 
                
                </div>
            
            <div  className=" sm:mb-[50px] mt-8    flex items-center
             text-amber-50 rounded-3xl justify-center  
             mb-2  shadow-amber-200  
